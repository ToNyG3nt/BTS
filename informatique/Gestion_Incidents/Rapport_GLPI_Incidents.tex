...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, keepaspectratio]{screen/image.png}
        \caption{Liste des utilisateurs créés dans GLPI}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, keepaspectratio]{screen/14.png}
        \caption{Catégories de tickets configurées}
    \end{minipage}
\end{figure}

\subsection{Organisation et intérêt}

Les utilisateurs (\texttt{enseignant1}, \texttt{admin1}) disposent du profil \textbf{Self-Service} : ils peuvent créer des tickets et suivre l'avancement des leurs, sans accès à l'administration. Le compte \texttt{technicien1} dispose du profil \textbf{Technicien} : il consulte, prend en charge et résout les tickets qui lui sont assignés. Cette séparation des droits garantit la sécurité et la cohérence du système.
