...
Avant d'installer GLPI, j'ai vérifié que la pile LAMP était opérationnelle sur mon poste Debian. J'ai contrôlé l'état des services Apache et MariaDB avec les commandes suivantes :
...
Les deux services sont actifs (\texttt{active (running)}).

\begin{figure}[H]
    \centering
    % capture_services_lamp.png
    \includegraphics[width=0.85\textwidth, height=7cm, keepaspectratio]{capture_services_lamp.png}
    \caption{Services Apache et MariaDB actifs sur Debian}
\end{figure}
