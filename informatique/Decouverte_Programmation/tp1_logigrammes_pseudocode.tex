...
\begin{tikzpicture}[every node/.style={font=\sffamily}, node distance=1.7cm, >=latex]
  ...
  \node (long) [draw, rectangle, right=2.5cm of test, minimum width=3.2cm, minimum height=0.8cm] {Afficher « Votre nom est trop long »};
  \node (court) [draw, rectangle, below=of test, minimum width=3.2cm, minimum height=0.8cm] {Afficher « Votre nom est trop court »};
  \node (end) [draw, rectangle, rounded corners, below=of court, minimum width=2.5cm, minimum height=0.8cm] {Fin};
  
  \draw[->] (start) -- (input);
  \draw[->] (input) -- (test);
  \draw[->] (test.east) -- node[above, sloped] {Oui} (long.west);
  \draw[->] (test.south) -- node[left] {Non} (court.north);
  
  \draw[->] (court) -- (end);
  \draw[->] (long.south) |- (end.east);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[every node/.style={font=\sffamily}, node distance=1.7cm, >=latex]
  ...
  \node (long) [draw, rectangle, right=2.5cm of test1, minimum width=3.2cm, minimum height=0.8cm] {Afficher « Votre nom est trop long »};
  \node (test2) [draw, diamond, aspect=2, below=of test1, inner sep=1pt, minimum width=3.5cm, minimum height=1.2cm] {longueur(nom) $<$ 30 ?};
  \node (court) [draw, rectangle, right=2.5cm of test2, minimum width=3.2cm, minimum height=0.8cm] {Afficher « Votre nom est trop court »};
  \node (end) [draw, rectangle, rounded corners, below=of test2, minimum width=2.5cm, minimum height=0.8cm] {Fin};

  \draw[->] (start) -- (input);
  \draw[->] (input) -- (test1);
  \draw[->] (test1.east) -- node[above, sloped] {Oui} (long.west);
  \draw[->] (test1.south) -- node[left] {Non} (test2.north);

  \draw[->] (test2.east) -- node[above, sloped] {Oui} (court.west);
  \draw[->] (test2.south) -- node[left] {Non} (end.north);

  \coordinate (join) at (long -| court);
  \draw[->] (long) -- (join);
  \draw[->] (court) -- (join);
  \draw[->] (join) -| (end.east);
\end{tikzpicture}
...
\begin{tikzpicture}[every node/.style={font=\sffamily}, node distance=1.7cm, >=latex]
  ...
  \node (aff) [draw, rectangle, right=2.5cm of test, minimum width=3.2cm, minimum height=0.8cm] {Afficher « Je suis au tour n°i »};
  ...
  \draw[->] (start) -- (init);
  \draw[->] (init) -- (test);
  \draw[->] (test.east) -- node[above, sloped] {Oui} (aff.west);
  \draw[->] (test.south) -- node[left] {Non} (end.north);
  
  \draw[->] (aff) -- (inc);
  \draw[->] (inc.west) -| (test.west);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[every node/.style={font=\sffamily}, node distance=1.7cm, >=latex]
  ...
  \node (i) [draw, rectangle, below=of start] {i $\leftarrow$ 1};
  \node (testi) [draw, diamond, aspect=2, below=of i] {i $\leq$ 3 ?};
  
  \node (repeat) [draw, rectangle, right=2.5cm of testi, minimum width=3.5cm] {Saisir phrase[i]};
  \node (testlen) [draw, diamond, aspect=2, below=of repeat, minimum width=3.5cm] {longueur(phrase[i]) $\leq$ 50 ?};
  \node (inc) [draw, rectangle, below=of testlen] {i $\leftarrow$ i+1};
  
  \node (concat) [draw, rectangle, below=3cm of testi, minimum width=4.5cm] {concat $\leftarrow$ phrase[1] + " " + phrase[2] + " " + phrase[3]};
  \node (aff) [draw, rectangle, below=of concat] {Afficher concat};
  \node (end) [draw, rectangle, rounded corners, below=of aff] {Fin};

  \draw[->] (start) -- (i);
  \draw[->] (i) -- (testi);
  
  \draw[->] (testi.east) -- node[above, sloped] {Oui} (repeat.west);
  \draw[->] (testi.south) -- node[left] {Non} (concat.north);
  
  \draw[->] (repeat) -- (testlen);
  \draw[->] (testlen.east) -- node[above] {Non} ++(1,0) |- (repeat.east);
  \draw[->] (testlen.south) -- node[left] {Oui} (inc.north);
  
  \draw[->] (inc.west) -| (testi.west);
...
\subsection*{Logigramme}
\begin{center}
\begin{tikzpicture}[every node/.style={font=\sffamily}, node distance=1.3cm, >=latex]
  \node (start) [draw, rectangle, rounded corners] {Début};
  \node (n) [draw, rectangle, below=of start] {Saisir N};
  \node (i) [draw, rectangle, below=of n] {i $\leftarrow$ 1};
  \node (testi) [draw, diamond, aspect=2, below=of i] {i $\leq$ N ?};
  
  \node (repeat) [draw, rectangle, right=2.5cm of testi, minimum width=3.5cm] {Saisir phrase[i]};
  \node (testlen) [draw, diamond, aspect=2, below=of repeat] {longueur(phrase[i]) $\leq$ 50 ?};
  \node (inc) [draw, rectangle, below=of testlen] {i $\leftarrow$ i+1};
  
  \node (concat) [draw, rectangle, below=3.5cm of testi, minimum width=4.5cm] {concat $\leftarrow$ phrase[1]};
  \node (i2) [draw, rectangle, below=of concat] {i $\leftarrow$ 2};
  \node (testi2) [draw, diamond, aspect=2, below=of i2] {i $\leq$ N ?};
  
  \node (concat2) [draw, rectangle, right=2.5cm of testi2, minimum width=4.5cm] {concat $\leftarrow$ concat + " " + phrase[i]};
  \node (inc2) [draw, rectangle, below=of concat2] {i $\leftarrow$ i+1};

  \node (aff) [draw, rectangle, below=2cm of testi2] {Afficher concat};
  \node (end) [draw, rectangle, rounded corners, below=of aff] {Fin};
  ...
  \draw[->] (testi.east) -- node[above, sloped] {Oui} (repeat.west);
  \draw[->] (repeat) -- (testlen);
  \draw[->] (testlen.east) -- node[above, sloped] {Non} ++(0.5,0) |- (repeat.east);
  \draw[->] (testlen.south) -- node[left] {Oui} (inc.north);
  \draw[->] (inc.west) -| (testi.west);
  \draw[->] (testi.south) -- node[left] {Non} (concat.north);
  ...
  \draw[->] (concat) -- (i2);
  \draw[->] (i2) -- (testi2);
  \draw[->] (testi2.east) -- node[above, sloped] {Oui} (concat2.west);
  \draw[->] (concat2) -- (inc2);
  \draw[->] (inc2.west) -| (testi2.west);
  \draw[->] (testi2.south) -- node[left] {Non} (aff.north);
