...
\midrule
7 & Application   & Interface utilisateur        & Message \\
6 & Présentation  & Format, chiffrement (SSL)    & Message \\
...
\begin{tabular}{lll}
\toprule
\textbf{Équipement} & \textbf{Couche OSI} & \textbf{Rôle} \\
\midrule
...
\texttt{ipconfig / ip addr} & Configuration IP locale \\
