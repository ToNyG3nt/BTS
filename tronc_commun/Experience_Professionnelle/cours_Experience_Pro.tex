...
\begin{itemize}
    ...
    \item Le temps passé à l'école est considéré comme du temps de travail effectif.
    \item La période d'essai est de 45 jours effectifs en entreprise.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Limites de la durée du travail (apprentis) :}
    \begin{itemize}
...
\begin{figure}[h!]
    ...
    \caption{Tableau Comparatif Droit du travail / Conventions Collectives}
    \label{fig:capture1}
\end{figure}
\end{document}
